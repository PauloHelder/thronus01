-- 1. Adicionar coluna BI na tabela members
ALTER TABLE members ADD COLUMN IF NOT EXISTS bi_number TEXT;
COMMENT ON COLUMN members.bi_number IS 'Bilhete de Identidade (Nº de BI)';

-- 2. Atualizar função de criação de usuário (para permitir vincular membro existente)
