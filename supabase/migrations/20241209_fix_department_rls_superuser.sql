...
-- Drop existing policies to recreate them with 'superuser' included
...
-- 1. DEPARTMENTS
-- Admins, Leaders, and Superusers can see all departments in their church
...
-- Admins/Leaders/Superusers can Insert/Update/Delete departments
...
-- Admins/Leaders/Superusers view all
...
-- Admins/Leaders/Superusers manage members
...
-- Admins/Leaders/Superusers manage schedules
